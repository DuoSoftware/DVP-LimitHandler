...
RestServer.post('/DVP/API/'+version+'/LimitAPI/Limit/MultipleKeys/Increment',function(req,res,next) {
...
RestServer.post('/DVP/API/'+version+'/LimitAPI/Limit/MultipleKeys/Decrement',function(req,res,next) {
